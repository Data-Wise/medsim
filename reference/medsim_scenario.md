...
- estimand:
  ...
  object declaring the estimand kind (`"point"`, `"interval"`,
  `"probabilistic"`, `"numeric"`). `NULL` (the default) is treated as
  `kind = "point"` throughout the package – full back-compatibility with
  existing scenarios.
