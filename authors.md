...
Source:
[`DESCRIPTION`](https://github.com/data-wise/medsim/blob/main/DESCRIPTION)

Tofighi D (2025). *medsim: Simulation Infrastructure for Mediation
Analysis*. R package version 0.0.0.9000,
<https://github.com/data-wise/medsim>.

    @Manual{,
      title = {medsim: Simulation Infrastructure for Mediation Analysis},
