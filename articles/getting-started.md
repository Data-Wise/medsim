...
To report accuracy metrics (bias, RMSE, …), give
[`medsim_run()`](https://data-wise.github.io/medsim/reference/medsim_run.md)
a `compute_truth` function. It shares the `(data, params)` signature of
your method and returns the *true* value of each quantity the method
estimates — here, taken directly from the data-generating parameters:
...
- Browse the GitHub repository at <https://github.com/Data-Wise/medsim>
  for the latest source, issues, and changelog.
