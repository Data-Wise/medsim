...
meta_cols <- attr(results$results, "medsim_meta_cols", exact = TRUE)
if (is.null(meta_cols)) meta_cols <- c("scenario", "replication", "elapsed", "error")
cat(sprintf("  Parameters:      %d\n", length(setdiff(names(results$results), meta_cols))))
cat("\n")
